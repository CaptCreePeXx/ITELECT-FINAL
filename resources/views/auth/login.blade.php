    ...
    <div class="w-full max-w-md mt-24 bg-gray-900 bg-opacity-70 rounded-2xl p-8 shadow-xl">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div>
                ...
                <input type="email" name="email" class="w-full p-3 rounded-lg bg-gray-800 text-white border border-gray-700 focus:border-yellow-400 focus:ring focus:ring-yellow-300 outline-none transition" required autofocus>
            </div>
